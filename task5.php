...
foreach($array as $key => $value){
    echo $value.' capital of '.$key.'<br>';
}
// ================================
//part 2
$sample_string = '672319';
$output = $sample_string[0].$sample_string[1].":".$sample_string[2].$sample_string[3].":".$sample_string[4].$sample_string[5];
echo $output;
?>